...
# Sprawdza, czy dwa przedziały czasowe kolidują, biorąc pod uwagę możliwość przekroczenia północy.
def is_collision(
...
# Generuje listę segmentów czasowych, uwzględniając przekroczenie północy.
...
# Sprawdza, czy dwa segmenty czasowe kolidują.`
